...
**Fast and Easy Testing (FET) Regime for Religious Organisations (ROs)**
...
Q4.	If I am medically eligible but yet to be fully vaccinated, what is the testing regime to adhere to?

All workers involved in physical classes must be fully vaccinated. If the worker is yet to be fully vaccinated, they should only be involved in physical classes when they have achieved fully vaccinated status.

Q5.	What happens if the FET mandatory testing is not adhered to?  
...
Q6.	Is FET mandatory for workers who are not involved in conducting religious classes for children 12 years and below?
...
Q7.	How will the FET be conducted?  
...
Q8.	What type of test will I have to take during the FET?

You will have to take the Antigen Rapid Test (ART). 


Q9. When am I considered ‘fully vaccinated’?

(a)	Vaccinated with no prior history of COVID-19 infection – starting 14 days after the day of vaccination and ending 270 days later.

(b)	Recovered from COVID-19 infection without prior vaccination – starting the day of testing positive for SARS-SoV-2 via a PCR test and ending 180 days later.
...
Q10.	Am I considered fully vaccinated if I have recovered from Covid-19?

Yes, you will be considered fully vaccinated for 180 days since the first positive test. 

**B. ESSS For ROs**

Q11.	Who bears the cost of the Antigen Rapid Test (ART) kits? 

The costs for the Antigen Rapid Test (ART) kits and supervisor training for all eligible will be borne by the Government until 31 Mar 2022.  


Q12.	Is it mandatory for staff to be trained supervisors for the Employer-Supervised Self-Swabs (ESSS)? 
...
Q13.	How can ROs register for self-collection of kits for ESSS and the Swab Registration System (SRS)?
...
•	The kits, funded by the Government, will be provided monthly (till 31 Mar 2022). 


Q14.	How can ROs record the test results on the Swab Registration System (SRS)?

ROs are to upload the ART results of their employees into SRS. CPRO will assist to create SRS accounts for your company using the same information provided in the form (see Q13). The POCs nominated will receive an email notification after the accounts have been set up. Please check your junk mail folder if the POCs do not receive the email. 
...
Q15.	What if my RO operates across various venues/studios?

ROs with multiple venues are encouraged to submit a form for each venue, however all outlets should indicate the same collection address (see the form in Q13 for more details).


Q16.	My RO has several locations, am I able to be the supervisor for all the branches? 

No. You are required to appoint different supervisors for each of the locations. However, all outlets should indicate the same collection address (see Q15). Kindly note that only 1 supervisor is only allowed to be assigned under one UEN. 


Q17.	What do I do if my Swab Registration System (SRS) account gets blocked?

Please email CPRO at CPRO@mccy.gov.sg for assistance.


Q18.	If my cleaner comes in on an ad hoc basis (e.g. once in 2 weeks) and may be a different cleaner each time from the cleaning company, how do I go about doing the FET every 7 days?
...
Q19.	The workers in my RO are all part-timers and are often on rotation and some not teaching for periods of time.  Do they need to do testing if they are not in current rotation, or aren't teaching for the time being? 
...
Q20.	Some of our workers are volunteers and they serve several other companies apart from our RO. Do we include their test results similarly with our other employees?
...
Q21.	What should I do if a worker obtains a positive ART result (AG+) or two invalid ART results? 
...
**C. Other General FET Queries**

Q22. Am I still allowed to continue conducting classes if I missed my weekly testing?
...
Q23.	If I am not conducting classes this month, do I need to undergo FET?
...
Q24.	If I am discontinuing all my in-person classes and only conducting online classes, do I still have to undergo FET?
...
Q25.	If I am teaching at different ROs/other venues, will I need to take a separate test with each of them?
...
Q26.	I am currently a staff at other workplaces that already require me to get tested every week. Can I be exempted from FET for ROs?
...
Q27.	What if I am ill on the day of my test? Can I still take the ART?
...
Q28.	May I use ART kits that are not provided by the Government?
...
Q29.	If I have a religious rite (eg. Baptism) that involves children aged 12 years and below, are the workers required to undergo FET?
...
**D. Steps for ROs - Getting on Board ESSS**
